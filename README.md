...
This project provides a devcontainer running PHP that you can use to do youall of your development work, it has the PHP and PostgreSQL extensions installed
...
There's a container named `webserver` running Apache and PHP, it's 
